...
export default function SignUp(props) {
  ...
  const handleSubmit = async(event) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8080/auth/sign-up', {  // Replace with your actual API endpoint
        method: 'POST',
        headers: {
      ...
      if (responseText.includes('User registered successfully')) {
        ...
        setSubmitError('Registration failed: Email already exists');
      } else {
    ...
    <AppTheme {...props}>
      ...
      <SignUpContainer direction="column" justifyContent="space-between">
        <Card variant="outlined">
          <Icon sx={{ width: '64px', height: '64px' }}>
            <img src={Webicon} alt="Your Icon" style={{width: '64px', height: '64px'}} />
          </Icon>
          <Typography
            component="h1"
            variant="h4"
